...
inputGeneExpressionDataFilePath = paste0(dataFolder, "originalGeneExpressionDataSets//originalHippocampalCa1RegionGeneExpressionData.csv")
...
phenotypesFilePath = paste0(dataFolder, "phenotypes//AlzheimersHippocampusCa1Phenotypes.csv")
...
# NECESSARY:
enhancerChromatinFilePath = NULL 
