...
tissueName = "Brain"
bodyRegion = "LateralTemporalLobe" 

inputGeneExpressionDataFilePath = paste0(dataFolder, "originalGeneExpressionDataSets//originalLateralTemporalLobeRegionGeneExpressionData.csv")
...
ourPower = 10 # if we have a recommended power in mind please put that there (this can come from analyzing the Soft-Thresholding Analysis results)
