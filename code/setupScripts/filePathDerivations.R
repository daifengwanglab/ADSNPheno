...
#grnResultsCombinedFileNameCSV = paste0(filePathOfAll4GRNs, disease, "_", bodyRegion, "_", dataScaling, "_geneExpressionGeneRegulatoryNetwork.csv")
#grnResultsCombinedFileNameRData = paste0(filePathOfAll4GRNs, disease, "_", bodyRegion, "_", dataScaling, "_geneExpressionGeneRegulatoryNetwork.RData")
#grnResultsComboForPythonInputFileNameCSV = paste0(filePathOfAll4GRNs, disease, "_", bodyRegion, "_", dataScaling, "rtnTrrust2Genie3AndTrena_geneExpressGeneRegNet.csv")
...
#newPath = paste0(outputName, disease, "_", bodyRegion, "_", dataScaling, "_power", powerVal, "_", newDate, ".csv")
